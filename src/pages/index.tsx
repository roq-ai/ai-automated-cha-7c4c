...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ai automated chat`}</title>

        <meta
          name="description"
          content="Welcome to ai automated chat, your 24/7 assistant, proficient in addressing all your Java-related queries by understanding the nuances of our website, javaeasycodings.blogspot.com"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593508512255-86ab42a8e620?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBSSUyMGNoYXR8ZW58MHx8fHwxNjk1NzM1MDY0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@minhphamdesign?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Minh Pham`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ai automated chat, your 24/7 assistant, proficient in addressing all your Java-related queries by understanding the nuances of our website, javaeasycodings.blogspot.com`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="System Owner" type="system-owner" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
